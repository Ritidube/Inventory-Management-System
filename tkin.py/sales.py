...
#======Images=========
        self.bill_photo=Image.open("tkin.py/Images/cat2.jpg")
 ...
 #=======================================
    ...
    def show(self):
       ...
       # print(os.listdir('../PYTHON PROJECT'))
        for i in os.listdir('tkin.py/bill'):
            if i.split('.')[-1]=='txt':
    ...
    def get_data(self,ev):
      ...
      #  print(file_name)
        ...
        fp=open(f'tkin.py/bill/{file_name}','r')
        for i in fp:
    ...
    def search(self):
        if self.var_invoice.get()=="":
            ...
            if self.var_invoice.get() in self.bill_list:
                fp=open(f'tkin.py/bill/{self.var_invoice.get()}.txt','r')
                self.bill_area.delete('1.0',END)
                for i in fp:
                    self.bill_area.insert(END,i)
                fp.close()
